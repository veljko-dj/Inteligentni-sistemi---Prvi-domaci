/*
 * Ovde je izmena sto ako provali da je V onda ce igrati nula i tako ga pobediti sigurno
 * Ali postoji sansa da izgubi ako je verovatnoca greske 10%
 * */
package rs.ac.bg.etf.players;

public class Ulazem1v2 extends Player {
